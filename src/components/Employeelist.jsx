...
import Abi from "../assets/Abi.jpeg";
    ...
    return(
        <div className={Styles.gri}>
            {employees.map(function (employee) {
                return <Employeecard avatar={employee.avatar} pp={employee.profilePic} cp={employee.coverPic} fp={employee.favoriteFoodPic} id={employee.id} name={employee.name} email={employee.email} age={employee.age} city={employee.city} country={employee.country} status={employee.status} skills={employee.skills.join("| |")} hobby={employee.hobby}/>;
            })}
        </div>
    );
